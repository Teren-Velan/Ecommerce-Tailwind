            ...
            {HeroData.map((data) => (
              <div key={data.id}>
                <div className="grid grid-cols-1 sm:grid-cols-2">
                  ...
                  <div className="flex flex-col justify-center gap-4 text-center order-2 sm:text-left  sm:order-1 sm:pl-3 sm:pt-0 relative z-10 ">
                    <h1 className="text-2xl sm:text-4xl lg:text-3xl font-bold">
                      {data.subtitle}
                    </h1>
