      ...
      <div className="container">
        ...
        >
          ...
          <div className="p-6 sm:p-8">
            ...
            <h1
              data-aos="zoom out"
              className="text-4xl lg:text-7xl uppercase font-bold"
            >
              {data.title}
            </h1>
          ...
          {/* third column */}
          <div className="flex flex-col justify-center gap-4 sm:p-8">
            <p data-aos="zoom-out" className="text-lg font-bold">
              {data.title2}
            </p>
